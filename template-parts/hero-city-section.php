<section class="relative w-full">
  <?php
  $heroImage = lid_field('hero_background_image', '', 'url');
  ...
  <?php if ($heroImage): ?>
    <div class="absolute inset-0 grid grid-cols-3 gap-0">
      ...
      <div
        class="bg-cover bg-center col-start-2 col-span-2"
  ...
  <!-- Gradient Overlay -->
  <div class="absolute inset-0 grid grid-cols-3 gap-0">
    <div class="bg-primaryBlue h-full"></div>
    <div class="col-start-2 col-span-2 h-full bg-gradient-to-r from-primaryBlue via-primaryBlue/80 to-transparent"></div>
  </div>
  ...
  <div class="container mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 items-center gap-10 relative z-10">
    ...
    <div>
      ...
      <p class="text-lg mb-6 text-white" data-sr>
  ...
  <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
    <svg data-name="Layer 1" class="relative block h-[150px] w-[calc(118%+1.3px)]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
      <path d="M598.97 114.72L0 0 0 120 1200 120 1200 0 598.97 114.72z" class="fill-white"></path>
    </svg>
  </div>
